...
// V4.0 / COSMETIC 03 — cookie consent manager.
const initCookieConsent = () => {
  ...
  const setSettingsValues = (value) => {
    settings.querySelector('[data-cookie-category="analytics"]')?.toggleAttribute("checked", !!value.analytics);
    settings.querySelector('[data-cookie-category="advertising"]')?.toggleAttribute("checked", !!value.advertising);
