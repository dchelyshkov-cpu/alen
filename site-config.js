/* ALENINDAHOUSE+ canonical content map — V4.0 stable. */
window.ALENINDAHOUSE_CONFIG = {
  ...
  typographyCheckpoint: {variant:"MANROPE-INTER", display:"Manrope", body:"Inter", heroTitle:"single-size-across-lines", carouselNavigation:"glyph-arrows-over-image"},
  sections: [
