...
window.ALENINDAHOUSE_CONFIG = {
  ...
  typographyCheckpoint: {variant:"VISUAL-TEST-MANROPE-INTER", display:"Manrope", body:"Inter", heroTitle:"single-size-across-lines", carouselNavigation:"glyph-arrows-over-image"},
  sections: [
